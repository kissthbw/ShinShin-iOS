//
//  CompaniaTelefonicaTableViewController.swift
//  ShinShin
//
...
protocol CompaniaTelefonicaTableViewControllerDelegate:class{
...
class CompaniaTelefonicaTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.selectItemViewController(self, didFinishAddind: list[indexPath.row])
    }
